...
const ContactsCard = () => {
  return (
    <div className="contacts-card">
      <p className="contacts-text">Можете написать нам в Telegram или WhatsApp по номеру:{' '}
        <a className="contacts-text-link" href="tel:+78005553535">8 (800) 555-35-35</a>
      </p>
      <p className="contacts-text">Оставить сообщение на почту:{' '}
        <a className="contacts-text-link" href="mailto:impulse-camp@mail.ru">impulse-camp@mail.ru</a>
      </p>
      <div className="contacts__social">
        <p>Или зайти к нам в социальные сети:</p>
        <div className="contacts__social-icons">
        <a className="contacts-text-link" href="https://vk.com/impulse_msk" target="_blank">
        ...
        <a className="contacts-text-link" href="https://t.me/impulse_msk" target="_blank">
        ...
        <a className="contacts-text-link" href="https://www.instagram.com/impuls.moscow?igsh=dHF5MDhleXo5aXg=" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24">
            <path fill="currentColor"
